...
Gutenberg 23.6 always uses the iframe for the post editor, regardless of the `apiVersion` of the blocks in the post content. **WordPress 7.1 is planned to adopt this behavior and remove the conditional fallback.**
